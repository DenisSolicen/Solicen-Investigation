...
**Что мы выяснили:**
VK публиковал видео (по данным собранным до 29.03.2026) **ещё до того, как закончит их обработку**. В момент публикации на сервере есть только исходный файл (или промежуточная копия) с чудовищно высоким битрейтом — 41,6 Мбит/с вместо нормальных ~5,6 Мбит/с. В результате пользователи скачивают 26 ГБ вместо 3,5 ГБ.
