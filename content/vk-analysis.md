...
- Новое видео Куплинова обработалось спустя 13 часов после запланированной публикации. Оно работает. Сломанное видео (26 марта) по-прежнему в статусе «Временно недоступно». 26 ГБ файл по-прежнему доступен по прямой ссылке на CDN.
