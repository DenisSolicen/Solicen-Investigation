...
- **Итого:** От публикации до скрытия — 64 часа. От создания файла (по метаданным) до скрытия — 94 часа. В любом случае — VK не смог обработать видео за несколько суток. И даже за 150 часов.

### TL;DR
> От публикации (26 марта, 18:00) до скрытия — 64 часа. От создания файла (по метаданным, 25 марта) до скрытия — 94 часа. За это время VK не создал нормальную версию, не создал манифест, не удалил промежуточные файлы. Результатом стало не исправление, а сокрытие. Почти 130 часов, 26 ГБ мусора остаётся на CDN и доступны по прямой ссылке.
---
...
### TL;DR
> Спустя 150+ часов видео Куплинова всё ещё скрыто под статусом «Видео временно недоступно». При этом 26-гигабайтный сырой файл до сих пор доступен по прямой ссылке с CDN. После 1 апреля ссылка умрёт, но сам файл, скорее всего, никуда не денется.  
> У VK, похоже, просто нет механизма удаления сломанных и скрытых видео. Сколько терабайт такого «мёртвого груза» уже лежит на их серверах — остаётся только гадать.
...
На момент обновления (31 марта, 22:00):
