...
- **Итого:** От публикации до скрытия — 64 часа. От создания файла (по метаданным) до скрытия — 94 часа. В любом случае — VK не смог обработать видео за несколько суток. Почти за 130 часов.
