...
Похожие симптомы наблюдались у трех видео выложенных до этого:
- `«КУПЛИНОВ ТРЁТ МИЛЛИОН ЛОТЕРЕЙНЫХ БИЛЕТОВ ► Scritchy Scratchy #1»` - 24 марта
- `«ТОЛЬКО БОБРЫ ПЕРЕЖИЛИ КОНЕЦ СВЕТА ► Timberborn #1»` - 23 марта
- `«ОПЯТЬ НОЧНАЯ РАБОТА? ► Creepy Shift: Roadside Diner»` - 20 марта

Однако, стоит оговориться, что в их случае, проблема решалась на следующий день после публикации к чему уже успели привыкнуть пользователи, и после этого видео можно было спокойно смотреть, хотя и на день позже, чем должно быть. Добавлю и то, что пользователи сообщали, что у них звук в этих видео работает нормально, но некоторые писали обратное, и это было больше похоже на лотерею, кому повезет, а кому нет.
...
В комментариях к видео были тысячи жалоб с теми же симптомами. Я и сам наблюдал подобные проблемы у прошлых видео, за 24, 23, 20 марта, но там они решались, и я могу подтвердить лишь своими словами, сами по себе на следующий день.
